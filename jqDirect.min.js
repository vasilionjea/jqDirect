...
13)}});$.fn.jqDirect=function(options,args){return this.each(function(){var $this=$(this),instance=$this.data("jqdirect");if(!instance){instance=new jqDirect(this,options);$this.data("jqdirect",instance._init())}if(typeof options=="string"&&!/_init|_createMap|_geocode_address/.test(options))instance[options](args)})}})(jQuery);